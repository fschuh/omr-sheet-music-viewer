...
All tasks below are pending. Sizes are relative engineering effort, not delivery commitments: S = small localized work, M = several connected changes, L = substantial algorithm or cross-layer work. OCR work is intentionally unestimated until evaluated separately.
